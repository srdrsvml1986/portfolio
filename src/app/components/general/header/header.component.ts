...
export class HeaderComponent implements OnInit {
  responsiveMenuVisible: Boolean = true;
  ...
  ngOnInit(): void {
    this.checkScreenSize(); // İlk yüklemede ekran boyutunu kontrol et
  ...
  private checkScreenSize() {
    this.isMobileMode = window.innerWidth < 768; // 768px mobil breakpoint olarak belirlendi
  }
  ...
  // Menü kapandığında scroll'u tekrar aktif et
  closeMenu() {
